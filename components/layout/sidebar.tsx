...
import { ArrowLeftRight, ShoppingBag, Radio, Scale, DoorOpen, Bot, Hammer, Home, Archive, Map, BookOpen } from "lucide-react";
...
const districts = [
  ...
  { href: "/framework",     label: "Gov. Framework",    icon: BookOpen                   },
