...
export default async function BriefingsPage() {
  ...
  return (
    <AppShell pathname="/briefings" title="Council Chamber · Briefings" subtitle="Weekly briefings prepared for executive review inside the chamber." actions={<RefreshBriefButton />}>
