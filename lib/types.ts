...
export interface Offer { id: string; name: string; audience: string; problem: string; promise: string; pricingModel: string; priceMin: number; priceMax: number; status: "DRAFT" | "READY" | "LIVE" | "ARCHIVED"; ctaUrl: string; calUrl: string; deliverables: string[]; createdAt: string; updatedAt: string; }
...
export interface Lead { id: string; name: string; email: string; message: string; sourceType: "offer" | "asset"; sourceId: string; sourceName: string; refContentId: string; status: "NEW" | "CONTACTED" | "CONVERTED" | "ARCHIVED"; createdAt: string; }
