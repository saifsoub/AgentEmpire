...
export const cityInstitutions: CityInstitution[] = [
  ...
  { id: 's-university', name: 'S/ University', district: 'Learning Quarter', x: '42%', y: '18%', purpose: 'Structured learning, onboarding, certification, and capability growth for agents and humans.', relatedAgentRoles: ['@Sally', 'Skill Architect', 'Knowledge Curator'], relatedTools: ['curriculum registry', 'skill library', 'assessment logs'], futureIntegrations: ['LMS', 'GitHub docs', 'knowledge base'], rooms: ['Curriculum Hall', 'Assessment Lab', 'Knowledge Library'], status: 'ready' },
